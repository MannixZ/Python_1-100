...
def qucik_sort(origin_items, comp=lambda x, y : x <= y):
    '''快速排序'''
    items = origin_items[:]
...
def main():
    ...
    print(qucik_sort(items2, comp=lambda p1, p2: p1.age <= p2.age))
